<template>
  ...
  <section 
    ref="sectionRef"
    :class="[
      'w-full bg-[#123524] py-10 px-4 sm:py-14 transition-all duration-1000 ease-out transform',
  ...
  >
    <div class="max-w-5xl mx-auto">
      ...
      <div v-if="!submitted" class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
        ...
        >
          ...
          <div class="flex flex-col gap-3 text-sm sm:text-base">
            ...
            <a href="#" class="flex items-center gap-3 text-white/90 hover:text-white hover:translate-x-1 transition-all duration-300">
        ...
        <div 
          :class="[
            'bg-white rounded-2xl shadow-xl p-5 sm:p-7 transition-all duration-700 delay-400 transform',
            isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'
          ]"
        >
          <!-- Stepper -->
          <div class="flex items-center mb-6 overflow-x-auto pb-2">
            <template v-for="(step, i) in stepLabels" :key="step">
              ...
              <div v-if="i < stepLabels.length - 1" class="flex-1 h-px mx-1.5 sm:mx-2 mb-4 transition-all duration-500"
          ...
          <div class="relative overflow-hidden min-h-[340px]">
            <Transition name="fade-slide" mode="out-in">
              ...
              <div v-else-if="currentStep === 3" key="step3" class="flex flex-col gap-4">
                ...
                <div class="bg-emerald-50 border border-emerald-100 text-emerald-700 text-xs p-3 rounded-lg animate-pulse">
              ...
              <div v-else-if="currentStep === 4" key="step4" class="flex flex-col gap-4">
                <div>
                  ...
                  <div class="flex flex-wrap gap-2">
                    <button v-for="opt in discountOptions" :key="opt.val" type="button" @click="form.discount = opt.val"
                      :class="[
                        'px-4 py-1.5 text-sm font-medium rounded-full transition-all duration-300 border transform active:scale-95',
                ...
                <div class="bg-emerald-50 border border-emerald-100 text-emerald-700 text-xs p-3 rounded-lg">
      ...
      <div v-else class="max-w-md mx-auto animate-bounce-in">
        <div class="bg-white rounded-2xl shadow-xl p-8 text-center">
          <div class="mx-auto w-14 h-14 bg-emerald-500 rounded-full flex items-center justify-center mb-4 animate-scale-up">
  ...
  <footer class="bg-white text-[#667085]">
    <div
      ...
      <div class="flex flex-col items-center md:items-start gap-4 text-center md:text-left">
        <span
          class="flex justify-center w-14 text-2xl font-bold text-[#89EA5C] bg-[#E4FBCC] px-4 rounded-2xl hover:scale-105 transition-transform duration-300">{{ t("applyForm.brandName") }}</span>
      ...
      <div class="flex flex-col items-center md:items-end gap-4 text-center md:text-right">
        <div class="flex flex-col sm:flex-row gap-2 sm:gap-8">
          <p class="hover:text-gray-900 transition-colors duration-200 cursor-pointer">{{ t("footer.offer") }}</p>
          <p class="hover:text-gray-900 transition-colors duration-200 cursor-pointer">{{ t("footer.privacyPolicy") }}</p>
        </div>
        <a href="#" class="text-[#3F9A1F] hover:underline transition-all">{{ t("footer.telegram") }}</a>
      </div>
    </div>
  </footer>
</template>
