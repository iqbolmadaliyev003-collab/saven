      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          ...
          <div class="flex-shrink-0">
            <span
              class="text-2xl font-bold bg-gradient-to-r from-lime-400 to-lime-500 bg-clip-text text-transparent">saven</span>
          </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        <div class="space-y-6 lg:space-y-8">
          ...
          <p class="text-gray-600 text-base sm:text-lg leading-relaxed">
            Saven a'zolari — chegirma qidirayotgan minglab faol xaridorlar. Ariza qoldiring, 24 soat ichida hamkorlilkni
            boshlayizmiz.
          </p>
