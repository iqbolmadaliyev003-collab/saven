      ...
      <header class="rounded-b-2xl sticky top-0 bg-white/40 backdrop-blur-md z-50">
        <div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex items-center justify-between h-16">
            ...
            <div>
              <span
                class="flex justify-center items-center w-10 text-xl font-bold text-[#89EA5C] px-4 rounded-3xl">{{ t("applyForm.brandName") }}</span>
            </div>

            <!-- Desktop Navigation -->
            <nav class="hidden md:flex items-center gap-8">
              <a href="#Howitworks" @click.prevent="scrollToSection('Howitworks')"
                class="text-gray-700 hover:text-gray-900 text-sm font-medium">{{ t("nav.howItWorks") }}</a>
              <a href="#Afzalliklar" @click.prevent="scrollToSection('Afzalliklar')"
                class="text-gray-700 hover:text-gray-900 text-sm font-medium">{{ t("nav.benefits") }}</a>
              <a href="#KopSoraladiganSavollar" @click.prevent="scrollToSection('KopSoraladiganSavollar')"
                class="text-gray-700 hover:text-gray-900 text-sm font-medium">{{ t("nav.faq") }}</a>
            </nav>

            <!-- Right section -->
            <div class="flex items-center gap-2 sm:gap-4">
              <!-- Til almashtirish (animatsiyali slider) -->
              <div class="hidden sm:flex relative items-center bg-gray-100 rounded-full p-1 w-[76px]">
                <span
          ...
          <Transition name="mobile-nav">
            <nav v-if="mobileMenuOpen" class="md:hidden pb-4 flex flex-col gap-3">
              ...
              <a href="#KopSoraladiganSavollar" @click.prevent="scrollToSection('KopSoraladiganSavollar')"
                class="text-gray-700 hover:text-gray-900 text-sm font-medium">{{ t("nav.faq") }}</a>
              <div class="relative flex items-center bg-gray-100 rounded-full p-1 w-[76px] mt-2">
                <span
                  class="absolute top-1 bottom-1 left-1 w-[34px] bg-white rounded-full shadow-sm transition-transform duration-300 ease-out"
                  :class="lang === 'ru' ? 'translate-x-[34px]' : 'translate-x-0'
                    "></span>
                ...
                <div class="bg-white rounded-3xl overflow-hidden">
                  ...
                  <div class="bg-gradient-to-b from-gray-50 to-white p-4 space-y-3 min-h-96">
                    ...
                    <div class="flex flex-wrap gap-2 mb-3">
                      <span
                        class="bg-lime-400 text-gray-900 text-xs font-semibold px-3 py-1 rounded-full">{{ t("phoneMock.filterNearby") }}</span>
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div class="flex gap-6">
              ...
              <a href="#" class="text-sm text-lime-600 hover:text-lime-700 font-medium">{{ t("footer.telegram") }}</a>
            </div>
          </div>
        </div>
      </footer>
...
/* ===== Telefon mockup uchun animatsiya holatlari ===== */
...
/* Telefon mockup: doim yengil suzib turadi */
.phone-float {
